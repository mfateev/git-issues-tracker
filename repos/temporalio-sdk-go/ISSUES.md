...
| [#986](#986-awaitwithtimeout-does-not-cancel-its-timer-when-condition-is-satisfied) | 1 | 5 | AwaitWithTimeout does not cancel its timer when condition... |
| [#937](#937-add-ability-to-keep-session-open-in-case-of-a-worker-restart) | 0 | 7 | Add ability to keep session open in case of a worker rest... |
| [#884](#884-feature-request-add-ability-to-support-passing-sessions-from-parent-to-child-wf) | 2 | 3 | [Feature Request] Add ability to support passing sessions... |
...
| [#949](#949-allow-user-to-override-default-maximum-activity-attempts-in-test-suite) | 1 | 2 | Allow user to override default maximum activity attempts ... |
| [#533](#533-continueasnew-which-transfers-all-unprocessed-signals-to-new-run) | 0 | 4 | ContinueAsNew which transfers all unprocessed signals to ... |
| [#444](#444-maxrpctimeout-value-is-too-long) | 0 | 4 | maxRPCTimeout value is too long |
| [#351](#351-testing-cancellation-of-parent-workflow-with-child-workflow-panics) | 2 | 0 | [Testing] Cancellation of Parent Workflow with Child Work... |
...
| [#1037](#1037-calling-a-value-receiver-method-with-a-pointer-type-causes-a-panic-when-used-through-executeactivity) | 0 | 3 | Calling a value receiver method with a pointer type cause... |
| [#1035](#1035-workflowcheck-should-check-that-serialized-objects-do-not-have-unexported-non-json-ignored-fields) | 0 | 3 | Workflowcheck should check that serialized objects do not... |
...
| [#458](#458-testworkflowenvironment-fail-registerdelayedcallback-after-executeworkflow) | 1 | 1 | TestWorkflowEnvironment: Fail RegisterDelayedCallback aft... |
...
| [#439](#439-include-a-way-to-perform-assertions-on-the-workflow-signal-channel-in-the-testing-environment) | 1 | 0 | Include a way to perform assertions on the workflow signa... |
| [#358](#358-bug-the-json-input-is-invalid-in-the-workflow-history-and-with-a-wrong-encoding-for-accents) | 0 | 2 | [Bug] the json input is invalid in the workflow history a... |
| [#266](#266-expose-activity-start-and-completion-information-to-the-workflow-code) | 1 | 0 | Expose activity start and completion information to the w... |
| [#101](#101-add-ability-to-pass-channel-as-a-parameter-to-child-workflow-and-activity) | 1 | 0 | Add ability to pass Channel as a parameter to Child workf... |
| [#35](#35-add-ability-to-pass-configuration-to-a-workflow) | 1 | 0 | Add ability to pass configuration to a workflow |
| [#2098](#2098-update-childworkflowoptions-comment-to-indicate-the-default-workflowidreusepolicy-and-workflowidconflictpolicy) | 0 | 1 | Update ChildWorkflowOptions comment to indicate the defau... |
| [#2039](#2039-joining-errors-causes-testworkflowenvironment-to-hide-panics-and-pass-test) | 0 | 1 | Joining errors causes TestWorkflowEnvironment to hide pan... |
...
| [#1776](#1776-provide-flag-to-tell-the-update-handler-that-the-handling-is-from-a-re-apply) | 0 | 0 | Provide flag to tell the update handler that the handling... |
| [#1760](#1760-provide-workflow-local) | 0 | 0 | Provide "workflow local" |
| [#1693](#1693-provide-details-and-actionable-info-about-non-deterministic-errors) | 0 | 0 | Provide details and actionable info about Non Determinist... |
...
| [#186](#186-worker-reports-validation-error-on-processing-of-transient-decision) | 0 | 0 | Worker reports validation error on processing of transien... |
