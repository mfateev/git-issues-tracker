...
| Rank | Issue | 💬 | 👍 | Title |
|------|-------|-----|-----|-------|
| 1 | [#688](https://github.com/temporalio/sdk-python/issues/688) | 12 | 0 | [Bug] Workflow sandbox issues with Protobuf |
| 2 | [#638](https://github.com/temporalio/sdk-python/issues/638) | 12 | 1 | Importing 3rd party package `ruamel.yaml` anywhere causes fa... |
| 3 | [#160](https://github.com/temporalio/sdk-python/issues/160) | 12 | 0 | [Bug] OpenTelemetry interceptors report errors |
| 4 | [#1048](https://github.com/temporalio/sdk-python/issues/1048) | 11 | 0 | [Feature Request] Support raising cancellation in sync multi... |
...
| [#834](https://github.com/temporalio/sdk-python/issues/834) | 0 | 0 | [Bug] Python 3.13.3 on macOS Intel hangs post-test |
| [#826](https://github.com/temporalio/sdk-python/issues/826) | 0 | 0 | [Bug] test_unfinished_handler_on_workflow_termination fails ... |
| [#814](https://github.com/temporalio/sdk-python/issues/814) | 0 | 1 | [Bug] Python client not able to connect to self-hosted Tempo... |
| [#778](https://github.com/temporalio/sdk-python/issues/778) | 0 | 1 | [Bug] strange workflow task timeout |
| [#772](https://github.com/temporalio/sdk-python/issues/772) | 0 | 0 | [Bug] Investigate unused bind_f function |
| [#733](https://github.com/temporalio/sdk-python/issues/733) | 0 | 10 | [Bug] Unable to run workflows with OpenTelemetry and ddtrace |
| [#700](https://github.com/temporalio/sdk-python/issues/700) | 0 | 10 | [Bug] No clean way to cancel an activity and wait until it's... |
| [#699](https://github.com/temporalio/sdk-python/issues/699) | 0 | 1 | [Bug] `workflow.wait` broken with `asyncio.FIRST_COMPLETED` ... |
| [#688](https://github.com/temporalio/sdk-python/issues/688) | 0 | 12 | [Bug] Workflow sandbox issues with Protobuf |
| [#657](https://github.com/temporalio/sdk-python/issues/657) | 0 | 0 | [Bug] Cannot replace worker client if default Runtime is use... |
| [#655](https://github.com/temporalio/sdk-python/issues/655) | 0 | 1 | [Bug] KeyError: 'warnings' due to sandbox |
...
| [#675](https://github.com/temporalio/sdk-python/issues/675) | 0 | 2024-10-21 | [Feature Request] Auto-skip time in time-skipping ... |
| [#669](https://github.com/temporalio/sdk-python/issues/669) | 0 | 2024-10-14 | [Feature Request] Support / provide guidance on us... |
| [#657](https://github.com/temporalio/sdk-python/issues/657) | 0 | 2024-09-30 | [Bug] Cannot replace worker client if default Runt... |
| [#655](https://github.com/temporalio/sdk-python/issues/655) | 0 | 2024-09-30 | [Bug] KeyError: 'warnings' due to sandbox |
| [#652](https://github.com/temporalio/sdk-python/issues/652) | 0 | 2024-09-27 | [Bug] `ScheduleOverlapPolicy` has broken __eq__ |
| [#637](https://github.com/temporalio/sdk-python/issues/637) | 0 | 2024-09-06 | [Bug] Windows 3.12.5 builds are broken |
