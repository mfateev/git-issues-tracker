...
1. **Immediate:** Address test environment bugs blocking developer testing ([#2141](../repos/temporalio-sdk-go/issues.md#2141), [#2140](../repos/temporalio-sdk-go/issues.md#2140))
2. **Short-term:** Fix critical test environment timeout issues ([#1282](../repos/temporalio-sdk-go/issues.md#1282), [#866](../repos/temporalio-sdk-go/issues.md#866))
3. **Medium-term:** Implement graceful shutdown improvements ([#181](../repos/temporalio-sdk-go/issues.md#181)) - highest user demand
4. **Long-term:** Enhance observability and tracing features ([#829](../repos/temporalio-sdk-go/issues.md#829), [#1149](../repos/temporalio-sdk-go/issues.md#1149))
...
The resolution of [#916](../repos/temporalio-sdk-go/issues.md#916) (the most upvoted issue overall at 21 upvotes) demonstrates responsiveness to high-demand features. This pattern of prioritizing high-upvote issues should be extended to other popular requests.
...
|-------|---------|-------------|
| [#1282](../repos/temporalio-sdk-go/issues.md#1282) | 5 | Heartbeat timeout not raised while testing - timeouts are hardcoded to 10 min |
...
| [#351](../repos/temporalio-sdk-go/issues.md#351) | 2 | Cancellation of Parent Workflow with Child Workflow panics in tests |
| [#167](../repos/temporalio-sdk-go/issues.md#167) | 2 | Activity times out in test environment with child workflow |
| [#2141](../repos/temporalio-sdk-go/issues.md#2141) | 0 | Activity Alias Collision in Test Environment When Using Anonymous Functions (new) |
...
| [#1100](../repos/temporalio-sdk-go/issues.md#1100) | 1 | TestWorkflowEnvironment should surface errors and respect failure signal |
| [#982](../repos/temporalio-sdk-go/issues.md#982) | 1 | Cannot register mock activity with string name on test workflow environment |
| [#642](../repos/temporalio-sdk-go/issues.md#642) | 1 | Inconsistent behavior when asserting invocations - testify mocking limitation |

#### Analysis of Key Test Issues

**[#1282](../repos/temporalio-sdk-go/issues.md#1282) - Heartbeat Timeout Not Raised:** Activity timeouts are hardcoded to 600 seconds (10 minutes) in the test environment, with HeartbeatTimeout being ignored entirely. Users expecting their configured timeouts to be enforced in tests are surprised when tests pass despite improper heartbeat strategies. Workaround: Use `testsuite.StartDevServer` for real-time testing.

**[#866](../repos/temporalio-sdk-go/issues.md#866) - WorkflowExecutionTimeout Not Enforced:** Child workflows in unit tests are not timing out as expected. Only WorkflowRunTimeout is partially enforced. This has been open for over 3 years with recent confirmation the issue persists.

**[#642](../repos/temporalio-sdk-go/issues.md#642) - Mock Assertion Inconsistencies:** Invocation count assertions like `Once()` behave inconsistently - calling more than expected causes a panic (but test may still pass if workflow error isn't checked), while calling fewer fails the assertion. This stems from testify/mock library behavior. Recommendation: Avoid invocation count assertions and manually count if needed.

**Recommendation:** Create a dedicated test environment improvement sprint to address these blocking issues:
1. Fix timeout enforcement ([#866](../repos/temporalio-sdk-go/issues.md#866), [#1282](../repos/temporalio-sdk-go/issues.md#1282))
2. Fix child workflow interactions ([#351](../repos/temporalio-sdk-go/issues.md#351), [#167](../repos/temporalio-sdk-go/issues.md#167), [#2090](../repos/temporalio-sdk-go/issues.md#2090))
3. Address mock/assertion inconsistencies ([#642](../repos/temporalio-sdk-go/issues.md#642), [#2109](../repos/temporalio-sdk-go/issues.md#2109))
...
| Issue | Upvotes | Request |
|-------|---------|---------|
| [#829](../repos/temporalio-sdk-go/issues.md#829) | 6 | Use interceptor logger for all logs related to a workflow or activity |
...
| [#718](../repos/temporalio-sdk-go/issues.md#718) | 2 | Add metric for time passed from activity scheduling to last attempt |

**[#829](../repos/temporalio-sdk-go/issues.md#829) - Interceptor Logger for All SDK Logs:** Users want the logger returned by the interceptor chain to be used for all SDK-level logs (not just user code), enabling domain-specific log filtering, correlation with traces, and better incident scope assessment. A `ContextAwareLogger` interface has been proposed.

**[#1149](../repos/temporalio-sdk-go/issues.md#1149) - Custom Trace Attribute Keys:** The hardcoded trace attribute keys (`temporalWorkflowID`, `temporalRunID`, `temporalActivityID`) cannot be customized without implementing a full custom interceptor. Users request the ability to override these via TracerOptions.

**[#1330](../repos/temporalio-sdk-go/issues.md#1330) - TaskQueue in Trace Spans:** Adding TaskQueue to TracerStartSpanOptions would enable users to infer cross-service interactions in distributed tracing, particularly for architectures where different workers serve different task queues.
...
**[#89](../repos/temporalio-sdk-go/issues.md#89) - Refactor to Avoid Type Aliasing:** The current SDK uses type aliasing to separate internal implementation from public APIs, but this causes issues with Go tooling. The proposal is to create public copies of all interfaces and structures, casting to/from internal types.

**[#1410](../repos/temporalio-sdk-go/issues.md#1410) - Migrate from golang/mock:** The github.com/golang/mock project has been deprecated. The SDK should migrate to the maintained fork go.uber.org/mock. This is a search-and-replace change.
...
| [#1114](../repos/temporalio-sdk-go/issues.md#1114) | 1 | Support activity functions with variadic arguments |

**[#1114](../repos/temporalio-sdk-go/issues.md#1114) - Variadic Activity Arguments:** Activity functions with variadic parameters (like gRPC clients generated by protoc) cannot be directly registered and called from workflows. Users must create wrapper functions. Supporting variadic arguments would simplify integration of third-party APIs as activities.
...
| [#884](../repos/temporalio-sdk-go/issues.md#884) | 2 | 2024-12-16 | Session passing to child workflows |
...
**Needs Triage:**
- High-upvote stale issues ([#181](../repos/temporalio-sdk-go/issues.md#181), [#829](../repos/temporalio-sdk-go/issues.md#829)) - confirm still relevant and prioritize
...
- Architectural improvements that require significant planning ([#89](../repos/temporalio-sdk-go/issues.md#89))
...
- [#181](../repos/temporalio-sdk-go/issues.md#181), [#937](../repos/temporalio-sdk-go/issues.md#937), [#1086](../repos/temporalio-sdk-go/issues.md#1086) - All relate to graceful worker shutdown with session/activity completion

**Test Environment Timeout Cluster:**
- [#866](../repos/temporalio-sdk-go/issues.md#866), [#1282](../repos/temporalio-sdk-go/issues.md#1282), [#1167](../repos/temporalio-sdk-go/issues.md#1167) - All relate to timeouts not being properly enforced/configurable in tests

**Timer Cancellation Cluster:**
- [#986](../repos/temporalio-sdk-go/issues.md#986), [#1125](../repos/temporalio-sdk-go/issues.md#1125) - Both relate to timers not being cancelled when no longer needed
...
- [ ] Fix OpenTelemetry metric type issue ([#2140](../repos/temporalio-sdk-go/issues.md#2140))
- [ ] Fix test environment activity alias collision ([#2141](../repos/temporalio-sdk-go/issues.md#2141))
- [ ] Address test environment panic on joined errors ([#2039](../repos/temporalio-sdk-go/issues.md#2039))

### Phase 2: Developer Experience (Short-term)

- [ ] Fix heartbeat timeout not raised in testing ([#1282](../repos/temporalio-sdk-go/issues.md#1282))
- [ ] Fix TestWorkflowEnvironment timeout enforcement ([#866](../repos/temporalio-sdk-go/issues.md#866))
- [ ] Fix MutableSideEffect cmp function ignored in tests ([#2109](../repos/temporalio-sdk-go/issues.md#2109))
- [ ] Address test environment goroutine leaks ([#2090](../repos/temporalio-sdk-go/issues.md#2090))
- [ ] Fix context cancellation non-determinism ([#1208](../repos/temporalio-sdk-go/issues.md#1208))

### Phase 3: Feature Expansion (Medium-term)

- [ ] Implement clean worker shutdown with session wait ([#181](../repos/temporalio-sdk-go/issues.md#181)) - **highest user demand**
- [ ] Add interceptor logger for workflow/activity logs ([#829](../repos/temporalio-sdk-go/issues.md#829))
- [ ] Implement serialization context for codecs ([#1352](../repos/temporalio-sdk-go/issues.md#1352))
- [ ] Allow custom trace attribute keys ([#1149](../repos/temporalio-sdk-go/issues.md#1149))
- [ ] Cancel AwaitWithTimeout timers when condition satisfied ([#986](../repos/temporalio-sdk-go/issues.md#986))

### Phase 4: Maintenance (Ongoing)

- [ ] Triage 101 stale issues
- [ ] Refactor SDK to avoid type aliasing ([#89](../repos/temporalio-sdk-go/issues.md#89))
- [ ] Migrate away from golang/mock ([#1410](../repos/temporalio-sdk-go/issues.md#1410))
- [ ] Update uber-go/tally dependency in contrib ([#899](../repos/temporalio-sdk-go/issues.md#899))
...
|---|-------|----------|---------|--------|
| 1 | [#181](../repos/temporalio-sdk-go/issues.md#181) | Enhancement | **16** | Clean worker shutdown (most upvoted) |
| 2 | [#89](../repos/temporalio-sdk-go/issues.md#89) | Enhancement | **7** | Refactor to avoid type aliasing |
| 3 | [#829](../repos/temporalio-sdk-go/issues.md#829) | Enhancement | **6** | Interceptor logger for all SDK logs |
| 4 | [#1282](../repos/temporalio-sdk-go/issues.md#1282) | Bug | **5** | Heartbeat timeout not raised in testing |
| 5 | [#1352](../repos/temporalio-sdk-go/issues.md#1352) | Enhancement | **4** | Serialization context for codecs |
| 6 | [#1149](../repos/temporalio-sdk-go/issues.md#1149) | Enhancement | **4** | Custom trace attribute keys |
| 7 | [#866](../repos/temporalio-sdk-go/issues.md#866) | Bug | **4** | TestWorkflowEnvironment timeout enforcement |
| 8 | [#313](../repos/temporalio-sdk-go/issues.md#313) | Enhancement | **4** | Local activity input in history |
| 9 | [#899](../repos/temporalio-sdk-go/issues.md#899) | Security | 0 | CVE in uber-go/tally dependency (contrib) |
| 10 | [#2141](../repos/temporalio-sdk-go/issues.md#2141) | Bug | 0 | Activity alias collision in tests (new) |
| 11 | [#2140](../repos/temporalio-sdk-go/issues.md#2140) | Bug | 0 | OpenTelemetry incorrect metric type (new) |
| 12 | [#2109](../repos/temporalio-sdk-go/issues.md#2109) | Bug | **2** | MutableSideEffect cmp function ignored |
| 13 | [#1208](../repos/temporalio-sdk-go/issues.md#1208) | Bug | **2** | Context cancellation non-determinism |
| 14 | [#1410](../repos/temporalio-sdk-go/issues.md#1410) | Enhancement | **2** | Migrate away from golang/mock |
| 15 | [#937](../repos/temporalio-sdk-go/issues.md#937) | Enhancement | 0 | Keep session open across worker restart |
...
1. **Worker lifecycle management** ([#181](../repos/temporalio-sdk-go/issues.md#181), [#937](../repos/temporalio-sdk-go/issues.md#937), [#1086](../repos/temporalio-sdk-go/issues.md#1086)) - Graceful shutdown with sessions is the most requested feature with 16 upvotes on [#181](../repos/temporalio-sdk-go/issues.md#181) alone

2. **Test environment reliability** ([#1282](../repos/temporalio-sdk-go/issues.md#1282), [#866](../repos/temporalio-sdk-go/issues.md#866), [#2109](../repos/temporalio-sdk-go/issues.md#2109)) - Timeout enforcement and behavior parity with production are critical for developer confidence

3. **Observability** ([#829](../repos/temporalio-sdk-go/issues.md#829), [#1149](../repos/temporalio-sdk-go/issues.md#1149), [#1330](../repos/temporalio-sdk-go/issues.md#1330)) - Better logging and tracing integration would improve debugging and incident response
